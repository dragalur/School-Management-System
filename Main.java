...
public class Main {
	...
	public static void main(String args[]) {
        ...
        Daniel.payFees(5000);
        Adam.payFees(6000);
        System.out.println("highSchool has earned $"+ highSchool.getMoneySpend());

        System.out.println("------Making SCHOOL PAY SALARY----");
        lizzy.receivedSalary(lizzy.getSalary());
        System.out.println("highSchool has spent for salary to " + lizzy.getName()
        +" and now has $" + highSchool.getMoneySpend());

        Primo.receivedSalary(Primo.getSalary());
        ...
        Jack.receivedSalary(Jack.getSalary());
